...
Glpi\Application\View\TemplateRenderer::getInstance()->display('pages/inventoryorganization/main.html.twig', [
    'title'      => 'Organisation de l\'Inventaire',
    'stats'      => $summary['stats'],
    ...
    'menu_items' => [
        [
            'title' => 'Entités',
            'description' => 'Créer et gérer les entités GLPI',
            'icon' => 'ti ti-building',
        ...
        [
            'title' => 'Lieux',
            'description' => 'Définir les lieux (bureaux, amphithéâtres, salles)',
            'icon' => 'ti ti-map-pin',
        ...
        [
            ...
            'description' => 'Créer les types de matériel (PC, laptops, projecteurs)',
            'icon' => 'ti ti-devices',
        ...
        [
            'title' => 'Étiquetage',
            'description' => 'Configurer l\'étiquetage normalisé',
            'icon' => 'ti ti-tag',
            'link' => 'inventoryorganization.labeling.php',
            'color' => 'warning',
        ],
        [
            'title' => 'Vérification Cohérence',
