@echo off
REM Script batch pour créer les catégories de tâches universitaires par défaut
...
if "%PHP_PATH%"=="" (
    ...
    echo Ou accedez au script via votre navigateur: http://localhost/unh_glpi/create_university_task_categories.php
    pause
    exit /b 1
)

echo Creation des categories de taches par defaut pour contexte universitaire...
echo.

cd /d "%~dp0"
"%PHP_PATH%" create_university_task_categories.php
