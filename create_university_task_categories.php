...
echo isCommandLine() ? '' : '<html><head><meta charset="UTF-8"><title>Création des catégories de tâches universitaires</title></head><body>';
echo isCommandLine() ? '' : '<h1>Création des catégories de tâches pour contexte universitaire</h1>';
