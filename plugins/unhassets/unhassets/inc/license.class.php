...
class PluginUnhassetsLicense extends CommonDBTM {
   ...
   /**
    * Le bouton "+" (Ajouter) dans les listes GLPI dépend de canCreate().
    *
    * Sur beaucoup de profils plugins, "Écriture" correspond à UPDATE, et non
    * forcément à CREATE. On autorise donc CREATE ou UPDATE.
    *
    * En Super-Admin, le droit config (UPDATE) doit aussi autoriser les actions.
    */
   ...
   public static function canDelete() {
    ...
    public function rawSearchOptions() {
        ...
        $tab[] = [
            ...
            'table'    => $this->getTable(),
            'field'    => 'license_type',
            'name'     => __('Type de licence', 'unhassets'),
            'datatype' => 'string',
        ];
